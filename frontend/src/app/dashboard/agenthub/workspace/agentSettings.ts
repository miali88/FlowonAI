...
export const LANGUAGE_OPTIONS = [
  ...
  export const VOICE_OPTIONS = {
    ...
    "de": [{ id: "de-voice1", name: "German Voice 1", file: "/voices/cartesia_german1.wav", voiceProvider: "cartesia" }],
    "ar": [{ id: "ar-voice1", name: "Arabic Voice 1", file: "/voices/cartesia_arabic1.wav", voiceProvider: "cartesia" }],
    "nl": [{ id: "nl-voice1", name: "Dutch Voice 1", file: "/voices/cartesia_dutch1.wav", voiceProvider: "cartesia" }],
    "zh": [{ id: "zh-voice1", name: "Mandarin Voice 1", file: "/voices/cartesia_mandarin1.wav", voiceProvider: "cartesia" }],
  };