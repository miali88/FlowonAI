      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-medium text-white mb-2">1.1 Personal Identification Information:</h3>
            ...
            <h3 className="text-xl font-medium text-white mb-2">1.2 Usage Data:</h3>
            <ul className="list-disc pl-6 mb-4 text-gray-300">
            ...
            <h3 className="text-xl font-medium text-white mb-2">1.3 Cookies and Tracking:</h3>
            <p className="text-gray-300 mb-4">
              We use cookies to enhance your experience, remember preferences, and perform analytics.
            </p>

            <h3 className="text-xl font-medium text-white mb-2">1.4 Correspondence:</h3>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-medium text-white mb-2">3.1 Service Providers:</h3>
            <p className="text-gray-300 mb-4">
              We share information with third-party service providers who perform services on our behalf, 
              such as payment processing and data storage.
            </p>

            <h3 className="text-xl font-medium text-white mb-2">3.2 Legal Requirements:</h3>
            <p className="text-gray-300 mb-4">
              We may disclose your information if required by law or in response to legal requests to protect 
              our rights and safety.
            </p>

            <h3 className="text-xl font-medium text-white mb-2">3.3 Business Transfers:</h3>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-medium text-white mb-2">4.1 Encryption:</h3>
            <p className="text-gray-300 mb-4">
              All data is encrypted using industry-standard encryption methods during transmission and at rest.
            </p>

            <h3 className="text-xl font-medium text-white mb-2">4.2 Access Controls:</h3>
            <p className="text-gray-300 mb-4">
              Access to your data is restricted to authorized personnel only.
            </p>

            <h3 className="text-xl font-medium text-white mb-2">4.3 Data Retention:</h3>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-medium text-white mb-2">5.1 Access and Update:</h3>
            <p className="text-gray-300 mb-4">
              You have the right to access and update your personal information through your account settings.
            </p>

            <h3 className="text-xl font-medium text-white mb-2">5.2 Deletion:</h3>
            <p className="text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-medium text-white mb-2">5.3 Objection and Restriction:</h3>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-medium text-white mb-2">6.1 Transfer Mechanisms:</h3>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-medium text-white mb-2">7.1 Updates:</h3>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-medium text-white mb-2">8.1 Questions and Concerns:</h3>
