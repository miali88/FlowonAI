import type { ChatbotConfig, FlowonWidget } from './types';
...
const createWidget = () => {
  ...
  const config: ChatbotConfig = window.embeddedChatbotConfig || { agentId: '' };
...
(window as Window & { [WIDGET_NAMESPACE]: FlowonWidget })[WIDGET_NAMESPACE] = {
