        ...
        if lead_email:
            lead_request_body = {
                    ...
                    "body": (
                        f"<div>"
                        f"<p>Hi {lead_name},</p>"
                        f"<p>Thank you for connecting with our landing page agent! At Flowon AI, we're offering a select group of business owners "
                        f"the chance to collaborate with us on building bespoke conversational AI agents tailored to their unique needs.</p>"
                        f"<p>These agents are designed to revolutionize customer interactions, streamline operations, and give businesses a "
                        f"competitive edge—but we can only take on a limited number of projects at a time.</p>"
                        f"<p>If you'd like to secure your spot, let's chat soon before the remaining slots fill up:</p>"
                        f"<p>Book a quick demo here: <a href='https://calendly.com/michael-flowon/30min?month=2024-11'>https://calendly.com/michael-flowon/30min?month=2024-11</a><br>"
                        f"Or simply reply to this email to start the conversation.</p>"
                        f"<p>I'd love to explore how we can create a custom AI solution for your business!</p>"
